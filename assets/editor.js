/**
 * AI Block Composer — editor sidebar.
 *
 ...
 * It sends the prompt to our REST endpoint, receives ready block markup, and
 * inserts it with wp.blocks.parse (server owns the fragile serialization).
 */
( function ( wp ) {
	...
	var editor = wp.editPost || wp.editor || {};
	...
	function Panel() {
		...
		children.push( el( 'style', { key: 'css' }, STYLE ) );
